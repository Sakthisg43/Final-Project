...
def user_post2():
    ...
    if request.method == 'POST':
        ...
        #return redirect(url_for('user_post2',act=act))  
    
    return render_template('insta/user_post.html',msg=msg,data=data,act=act,pdata=pdata)
...
@app.route('/user_post1', methods=['GET', 'POST'])
def user_post1():
    msg=""
    cnt=0
    uname=""
    ...
    return render_template('user_post1.html',msg=msg,data=data,mess=mess,act=act,st=st,pdata=pdata,vid=vid,bc=bc,bdata=bdata)
