...
--
-- Table structure for table `photo_chain`
--

CREATE TABLE `photo_chain` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `photo_chain_hash`
--

CREATE TABLE `photo_chain_hash` (
  `id` int(11) NOT NULL,
  `bcode` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
--
ALTER TABLE `photo_chain`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `photo_chain_hash`
--
ALTER TABLE `photo_chain_hash`
  ADD PRIMARY KEY (`id`);
COMMIT;
